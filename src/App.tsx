...
type View = 'generator' | 'history' | 'settings' | 'admin';
    ...
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#0F1115] text-[#1A1A1A] dark:text-gray-100 font-sans selection:bg-blue-100 dark:selection:bg-blue-900 transition-colors duration-300">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              {role === 'superadm' && (
                <button 
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${activeView === 'admin' ? 'bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800'}`}
                >
                  Admin
                </button>
              )}
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <AnimatePresence mode="wait">
            ...
            >
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-50 dark:bg-blue-900/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Settings className="text-blue-600 dark:text-blue-400 w-8 h-8" />
                </div>
                <h2 className="text-2xl font-bold">Configurações da Conta</h2>
                <p className="text-gray-500 dark:text-gray-400 text-sm">Gerencie seu perfil e preferências de sincronização.</p>
              </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      <span className="px-2 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-[10px] font-bold rounded-full uppercase">Conta Ativa</span>
                      <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-[10px] font-bold rounded-full uppercase">Sincronizado</span>
                    </div>
                  </div>
                </div>

                <div className="border-t border-gray-100 dark:border-gray-800 pt-6 space-y-4">
                  <h4 className="text-sm font-bold">Preferências</h4>
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-gray-500">Alternar entre modo claro e escuro.</p>
                      </div>
                    </div>
                    <button 
                      onClick={toggleTheme}
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium">Sincronização em Nuvem</p>
                        <p className="text-[11px] text-gray-500">Seu histórico está seguro no Firebase.</p>
                      </div>
                    </div>
          ...
          {activeView === 'admin' && role === 'superadm' && (
            <motion.div 
              key="admin"
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm">Gerencie usuários e permissões do sistema.</p>
                </div>
              </div>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-800">
                        ...
                        <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Criado em</th>
                                ...
                                <button 
                                  onClick={async () => {
                                    if (confirm('Tem certeza que deseja remover este usuário?')) {
                                      // No Supabase, deletar do profiles deleta o auth.users se configurado, 
                                      // mas aqui vamos apenas deletar o perfil para teste
                                      const { error } = await supabase
                                        .from('profiles')
                                        .delete()
                                        .eq('id', profile.id);
